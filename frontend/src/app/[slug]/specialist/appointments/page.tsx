...
export default function WorkplaceAppointmentsPage() {
  ...
  // Redirect to the main appointments page for now (will be refactored later)
  router.push('/specialist-portal/appointments');
