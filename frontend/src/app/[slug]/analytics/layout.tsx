...
export default function AnalyticsLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = [
    ...
    { name: 'Revenue', href: `${routes.analytics}/revenue` },
    { name: 'Customers', href: `${routes.analytics}/customers` },
    { name: 'Staff', href: `${routes.analytics}/staff` },
    { name: 'Services', href: `${routes.analytics}/services` },
    { name: 'Bookings', href: `${routes.analytics}/bookings` },
    { name: '⚡ Intelligence', href: `${routes.analytics}/intelligence` },
  ];
          ...
          >
            {tabs.map((tab) => {
              const isActive = pathname === tab.href || 
                (tab.href !== routes.analytics && pathname.startsWith(tab.href));
              return (
                <Link
                  key={tab.name}
                  href={tab.href}
