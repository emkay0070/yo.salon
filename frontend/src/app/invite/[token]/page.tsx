...
export default function StaffInvitePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Staff accounts log in to the main dashboard
      router.push('/login?message=Staff account created successfully');
    } catch (err: any) {
        ...
        <div className="max-w-[440px] w-full mx-auto px-6 sm:px-10 py-12">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-text-secondary text-sm">
              Complete your profile to access the {salonName} dashboard and manage your schedule.
            </p>
          </div>
