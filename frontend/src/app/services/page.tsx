        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <button onClick={() => {
              ...
              setFormData({ name: '', description: '', price: '', duration: '', category: '', active: true, image: null, image_preview: '' });
              setIsModalOpen(true);
            }} className="flex items-center gap-2 px-3 sm:px-4 py-2.5 bg-gradient-to-r from-[#FFD700] to-[#C9A227] text-black rounded-xl font-medium hover:opacity-90 transition-opacity shadow-lg shadow-[#FFD700]/10 text-sm">
